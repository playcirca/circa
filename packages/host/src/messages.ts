...
export function createPlaylistMessage(
...
export function createQuestionGivenMessage(
...
export const createPregameCountdownMessage = (
  current: number,
  total: number,
): ServerPreGameCountdown => {
  return {
...
export const createQuestionCountdownMessage = (
  current: number,
  total: number,
): ServerQuestionCountdown => {
  return {
